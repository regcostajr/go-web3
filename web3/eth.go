...
func (eth *Eth) GetStorageAt(address string, position *types.ComplexBigInt, defaultBlockParameter string) (string, error) {
...
//    - gas: QUANTITY - gas provided by the sender.
//    - input: DATA - the data send along with the transaction.
func (eth *Eth) GetTransactionByBlockHashAndIndex(hash string, index *types.ComplexBigInt) (*dto.TransactionResponse, error) {
...
//    - gas: QUANTITY - gas provided by the sender.
//    - input: DATA - the data send along with the transaction.
func (eth *Eth) GetTransactionByBlockNumberAndIndex(blockIndex *types.ComplexBigInt, index *types.ComplexBigInt) (*dto.TransactionResponse, error) {
...
//    2. error
func (eth *Eth) GetBlockByNumber(number *types.ComplexBigInt, transactionDetails bool) (*dto.Block, error) {
...
//    - QUANTITY, number - integer of the number of uncles in this block
//    - error
func (eth *Eth) GetUncleCountByBlockNumber(quantity *types.ComplexBigInt) (*big.Int, error) {
	// ensure that the hash has been correctly formatted
